...
INSERT INTO escola.Endereco (Rua, Numero, Bairro, Cidade, Estado, Pais, Cep) VALUES
...
INSERT INTO escola.Estudante (NumeroMatricula, DataMatricula, Status, ID_Pessoa) VALUES
    (12345, '2024-05-01', TRUE, 1),
    (54321, '2024-05-02', TRUE, 2);

INSERT INTO escola.Facilitador (Area, Horario, DataContratacao, Localizacao, Salario, ID_Pessoa) VALUES
    ('Matemática', 'Manhã', '2024-04-01', 'Sala 101', 2500.00, 1),
    ('Inglês', 'Tarde', '2024-04-02', 'Sala 102', 2800.00, 2);

INSERT INTO escola.Turma (NomeTurma, Horario, Localizacao, DataInicio, DataTermino, ID_Curso, ID_Facilitador) VALUES
...
INSERT INTO escola.Matricula (ID_Estudante, ID_Turma) VALUES
    (1, 1),
    (2, 2);

INSERT INTO escola.Modulo (Nome, Descricao, Horas, ID_Facilitador, ID_Curso) VALUES
